...
if(FAUST_FOUND)
  message(NOTICE "Faust found: ${FAUST_LIBRARY}, ${FAUST_INCLUDE_DIR}")
  ...
  set_target_properties(faust PROPERTIES IMPORTED_LOCATION ${FAUST_LIBRARIES})
  target_include_directories(faust INTERFACE ${FAUST_INCLUDE_DIRS})
else()
  message(WARNING "Faust not found")
  set(FAUST_LIBRARIES)
